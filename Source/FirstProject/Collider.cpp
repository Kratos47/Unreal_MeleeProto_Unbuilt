...
#include "ColliderMovementComponet.h"
...
ACollider::ACollider()
{
	...
	OurMovementComponent = CreateDefaultSubobject<UColliderMovementComponet>(TEXT("OurMovementComponent"));
...
void ACollider::Tick(float DeltaTime)
{
	...
	NewSpringArmRotation.Pitch =
		FMath::Clamp(NewSpringArmRotation.Pitch += CameraInput.Y, -80.0f, -15.0f);
