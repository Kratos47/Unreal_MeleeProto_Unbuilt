...
ALevelTransitionVolume::ALevelTransitionVolume()
{
	...
	TransitionVolume = CreateDefaultSubobject<UBoxComponent>
		(TEXT("TransitionVolume"));

	RootComponent = TransitionVolume;


	Billboard = CreateDefaultSubobject<UBillboardComponent>
...
void ALevelTransitionVolume::BeginPlay()
{
	...
	TransitionVolume->OnComponentBeginOverlap.
		AddDynamic(this, &ALevelTransitionVolume::OnOverlapBegin);
}
